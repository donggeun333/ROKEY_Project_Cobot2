...
``m0609_tool_sorter_unified.task_manager``를 기반으로, 다섯 공구를 각 고정 위치로
...
from m0609_tool_sorter_unified.grasp_selector import SORTABLE_TOOL_NAMES
from m0609_tool_sorter_unified.perception_core import comparable_depths
from m0609_tool_sorter_unified.schema import Detection
from m0609_tool_sorter_unified.task_manager import ToolSortTaskManager

...
The Modbus driver supports both the legacy
`pymodbus.client.sync.ModbusTcpClient` import used by ROS 2 Humble systems
and the newer `pymodbus.client.ModbusTcpClient` import layout.

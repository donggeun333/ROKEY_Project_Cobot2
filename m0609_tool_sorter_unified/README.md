...
colcon build --symlink-install --packages-select m0609_tool_sorter_unified
...
```bash
ros2 launch m0609_tool_sorter_unified tool_sorter.launch.py
```
...
```bash
ros2 launch m0609_tool_sorter_unified tool_sorter.launch.py execution_mode:=point
```

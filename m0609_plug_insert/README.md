...
(`m0609_tool_sorter_unified/models/best.pt`). 이 task가 보는 클래스는 둘뿐이다.
...
`m0609_tool_sorter_unified`의 `OnRobotGripper`(드라이버 서비스)를 쓴다.
...
```bash
ros2 run m0609_plug_insert plug_insert_standalone
```
```
